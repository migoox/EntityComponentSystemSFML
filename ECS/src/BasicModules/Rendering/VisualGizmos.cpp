...
void Basic::VisualGizmos::IDraw(sf::CircleShape circle)
{
	m_CircleShapes.push_back(circle);
}

void Basic::VisualGizmos::IDraw(sf::VertexArray verArr)
{
	m_VertexArrays.push_back(verArr);
}

void Basic::VisualGizmos::IDraw(sf::RectangleShape rect)
{
...
void Basic::VisualGizmos::IDrawOnce(sf::CircleShape circle)
{
	m_TempCircleShapes.push_back(circle);
}

void Basic::VisualGizmos::IDrawOnce(sf::VertexArray verArr)
{
	m_TempVertexArrays.push_back(verArr);
}

void Basic::VisualGizmos::IDrawOnce(sf::RectangleShape rect)
{
...
void Basic::VisualGizmos::Draw(sf::CircleShape circle)
{
	s_Instance.IDraw(circle);
}

void Basic::VisualGizmos::Draw(sf::VertexArray verArr)
{
	s_Instance.IDraw(verArr);
}

void Basic::VisualGizmos::Draw(sf::RectangleShape rect)
{
...
void Basic::VisualGizmos::DrawOnce(sf::CircleShape circle)
{
	s_Instance.IDrawOnce(circle);
}

void Basic::VisualGizmos::DrawOnce(sf::VertexArray verArr)
{
	s_Instance.IDrawOnce(verArr);
}

void Basic::VisualGizmos::DrawOnce(sf::RectangleShape rect)
{
