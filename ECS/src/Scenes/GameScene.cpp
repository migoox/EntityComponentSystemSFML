...
void GameScene::OnEnter()
{
	...
	auto& coll2 = m_Test2.AddComponent<Collider>(new RectangleCollider(sf::Vector2f(60.0f, 150.0f)));
	//coll1.Item->RotateCollider(50.0f);
	...
	auto& coll3 = m_Test3.AddComponent<Collider>(new RectangleCollider(sf::Vector2f(60.0f, 150.0f)));
